function Navigation() {
  const Navigation = (
    <div className="w-[375px] h-[88px] fixed bottom-0 bg-dark px-[32px] py-[67px]">
      <div className="flex-col gap-x-[48px]">
        <div id="Home" className="w-[24px] h-[24px]">
          <svg
        ...
        <div id="Movies" className="w-[24px] h-[24px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        <div id="Wallet" className="w-[24px] h-[24px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        <div id="Account" className="w-[24px] h-[24px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
