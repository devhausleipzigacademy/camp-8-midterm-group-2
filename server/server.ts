...
async function init() {
  ...
  fastify.zod.get(
    ...
    // removed $ref because I remember thats what we were supposed to do
    {
      // Copied below edits from Franz Code along
      schema: {
        operationId: "getAShowing",
        querystring: `showingQueryModel`,
        params: `showingParamsModel`,
      },
    },
  ...
  ////// Next section: uncommenting only for operationId
